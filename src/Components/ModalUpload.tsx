        ...
        <View className="bg-neutral-100 w-[90%] p-4 rounded-2xl">
          <View className="mb-3">
            <View className="w-full flex-col justify-center items-center mb-3">
              <Text className="text-heading4 mb-5">Tải tài liệu lên</Text>
              <Text className="text-danger-600">
                Lưu ý: Tên tệp không được chứa ký tự đặc biệt hoặc có dấu
              </Text>
              <View>
                {fileUpload ? (
                  ...
                  <View className="w-full h-[100px] flex justify-center items-center">
                    <Text className="text-body-base-regular text-center">Chưa có tệp nào được tải lên! Tải lên ngay ~! 🔥🌸👇👇</Text>
                  </View>
                )}
              </View>
            </View>
          ...
          <View className="w-full flex-row gap-3 justify-end items-center">
            ...
            >
              <Text className="text-white font-semibold">Tải tệp lên</Text>
            </TouchableOpacity>
            <TouchableOpacity
