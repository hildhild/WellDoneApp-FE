...
export const AddGroup = (props: {
  ...
  const handleChangeDateOfBirth = (event: any, date?: Date) => {
    if (date) {
  ...
  return (
    ...
    >
      <Modal animationType="fade" transparent={true} visible={openDatePicker}>
      ...
      <ScrollView className="w-full p-6">
        <View className="mb-3">
          <Text className="text-xl text-[#3F6212] font-semibold mb-3">
            Thông tin chung
          </Text>
          <Text className="mb-2 font-semibold text-neutral-500 text-lg">
            Tên nhóm
          </Text>
          <TextInput
            editable
        ...
        <View>
          ...
          <View className="flex-row items-center justify-between rounded-xl px-4 py-3 mb-2 border-[1px] border-gray-300 bg-white mt-3">
            ...
            <View className="flex-row gap-3 items-center">
              <View className="rounded-full p-2 bg-lime-200">
                <Text className="text-xs text-lime-800 font-semibold">
                  Thành viên
                </Text>
              </View>
              <Pressable>
          ...
          <Pressable className="mt-5 w-full flex justify-center items-center bg-lime-600 p-3 rounded-xl">
