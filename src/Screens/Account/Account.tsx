      ...
      <ScrollView>
        <View className="w-full flex justify-end items-center p-6">
          ...
          <View className="w-full mb-4">
            <Text className="mb-3 font-semibold text-neutral-500">
              Họ và tên:
            </Text>
            <View className="flex-row items-center bg-lime-100 rounded-lg p-4 mb-4">
              <TextInput
                ...
                onChangeText={(name) =>
                  setProfileData({ ...profileData, name: name })
                }
              />
            </View>
            <Text className="mb-3 font-semibold text-neutral-500">
            ...
            <View
              className={`flex-row items-center justify-between bg-lime-100 rounded-lg ${
                editable ? "py-2" : "py-4"
              } px-4 mb-4`}
            >
              {editable ? (
            ...
            <View className="flex w-full justify-center items-center">
              <Button
                className="w-[180px] !rounded-full mb-5 !bg-lime-300"
            ...
            <Text className="mb-3 font-semibold text-neutral-500">
              {isChangePassword ? "Mật khẩu hiện tại" : "Đổi mật khẩu:"}
            </Text>
            {isChangePassword && (
              <>
                <View className="flex-row items-center bg-lime-100 rounded-lg p-4 mb-4">
